...
export default class DrawerMenu {
  ...
  constructor(options = {}) {
    ...
    this._siteBrand = options.siteBrand ||
      document.querySelector('.header__siteBrand');
    this._primaryMenu = options.primaryMenu ||
      document.querySelector('.header__primaryMenu');
    this._tel = options.tel ||
      document.querySelector('.header__tel');
  ...
  _importMenu() {
    ...
    if (this._tel) {
      this._importTel(); // .drawerMenu__tel
    }
  }
  ...
  _importTel() {
    ...
    tel.classList.add('drawerMenu__item', '--tel');
    tel.appendChild(this._tel.cloneNode(true));
    this._menu.appendChild(tel);
